...
import { notificationSettings, FEATURE_IMAGE_URL } from '../../data';
      ...
      <Dialog open={state.image} onOpenChange={() => onClose('image')}>
        ...
        >
          <div
            ...
            style={{ backgroundImage: `url('${FEATURE_IMAGE_URL}')` }}
          >
            ...
            {notificationSettings.map((setting) => (
              <div key={setting.id} className="flex items-center justify-between space-x-4">
                <div className="flex flex-col space-y-1">
                  <Label htmlFor={setting.id} className="text-sm font-medium leading-none">
                    {setting.label}
                  </Label>
        ...
        <DialogContent onClose={() => onClose('payment')} className="sm:max-w-md">
          <div className="flex flex-col items-center p-4 text-center">
            ...
            <DialogHeader className="mb-4">
              ...
              <DialogDescription>
                Voce sera cobrado <strong>R$ 97,00/mes</strong>. Cancele quando quiser.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="mb-6 w-full rounded-lg border border-border bg-muted/30 p-4 text-sm">
              <div className="mb-2 flex justify-between">
                ...
                <span className="font-semibold">Lendario Pro</span>
              </div>
              <div className="mb-2 flex justify-between">
