...
const BookReaderTemplate: React.FC<BookReaderTemplateProps> = ({
  ...
  return (
    <div className="relative flex h-screen animate-fade-in overflow-hidden bg-background font-sans text-foreground">
      ...
      <div className="pointer-events-none fixed left-0 right-0 top-0 z-50 h-1 w-full bg-muted">
        <div
      ...
      <div
        ref={contentRef}
        className="relative h-full flex-1 overflow-y-auto scroll-smooth bg-background"
      ...
      <div
        className={cn(
          'fixed right-0 top-0 z-50 flex h-screen transform flex-col border-l border-border bg-card shadow-2xl transition-all duration-300 ease-in-out',
        ...
        <div className="relative shrink-0 border-b border-border bg-muted/10 p-4">
          ...
          <div className="mb-3 flex items-start gap-3 pr-8">
            ...
            <div className="min-w-0">
              <h2 className="mb-0.5 font-serif text-sm font-bold leading-tight">{book.title}</h2>
              <p className="text-xs text-muted-foreground">{book.author}</p>
            </div>
          </div>
          {/* Font Size Controls */}
          <div className="flex items-center justify-between border-t border-border/50 pt-2">
            <span className="text-[10px] uppercase tracking-wide text-muted-foreground">Fonte</span>
      ...
      {!sidebarOpen && (
        <Button
          variant="outline"
          size="icon"
          className="fixed right-6 top-6 z-50 h-12 w-12 rounded-full border border-border bg-background text-foreground shadow-lg hover:bg-muted"
